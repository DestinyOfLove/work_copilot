...
- 保留原文中的段落和换行
- **视觉一致性处理**：
  - SHBB网站：模拟CSS `white-space: normal`效果
  - 段落内换行转换为空格，段落间保留换行
  - 确保下载文档与网页显示完全一致
- 中文排版优化（首行缩进、两端对齐）
- 每篇文章自动分页
...
### 文件命名
- 单页保存：`网站标识_搜索词_第X页_YYYY-MM-DD_HH-MM-SS.docx`
- 多页保存：`网站标识_搜索词_第X页到第Y页_YYYY-MM-DD_HH-MM-SS.docx`
- 单篇保存：`网站标识_文章标题_YYYY-MM-DD_HH-MM-SS.docx`
- 网站标识：SCOPSR或SHBB
- 无搜索词时使用：`网站标识_文章集_...`
